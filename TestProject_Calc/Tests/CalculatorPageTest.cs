...
namespace TestProject_Calc.Tests
{
    ...
    {
        [SetUp]
        public void OpenCalculatorPage() => OpenPage(CalculatorPage.URL);
        ...
        public void InsertValidInputs_GetResults(string depositValue, string rateValue, string term, string day, Month month, string year, FinancialYearInput financialYear)
        {
            //Arrange
            var expectedValues = calculatorPage.GenerateInput(depositValue, rateValue, term, day, month, year, financialYear);
        ...
        {
            //Arrange
            var expectedValues = calculatorPage.GenerateInput(depositValue: depositValue, calculateExpectedValues: false);
        ...
        {
            //Arrange
            var expectedValues = calculatorPage.GenerateInput(rateValue: rateValue, calculateExpectedValues: false);
        ...
        {
            //Arrange
            var expectedValues = calculatorPage.GenerateInput(term: investmentTerm, financialYear: financialYear, calculateExpectedValues: false);
